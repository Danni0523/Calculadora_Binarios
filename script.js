...
function suma_binarios(b1, b2) {
  ...
  var principal =
    numerob1.length > numerob2.length || numerob1.length == numerob2.length
      ? b1
      : b2;
...
function resta_binarios(b1, b2) {
  if (b1 != b2) {
    ...
    var primera_suma = suma_binarios(
      invertir_minuendo.join(""),
      sustraendo_inicial
    );
    ...
    var resta_final = suma_binarios(
      invertir_minuendo_suma_final.join(""),
      sustraendo_inicial
    );
...
//SCRIPT PARA MULTIPLICAR BINARIOS
